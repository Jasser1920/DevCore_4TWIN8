      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <p style={{
            ...
            You have successfully authenticated. This is your client portal where you can view project progress, access documents, and communicate with your project team.
          </p>
          <div style={{
            marginTop: '16px',
            padding: '12px 16px',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ margin: '0 0 8px 0' }}>📋 <strong>Total Projects:</strong> 2</p>
              <p style={{ margin: '0 0 8px 0' }}>⏳ <strong>In Progress:</strong> 1</p>
              <p style={{ margin: '0 0 8px 0' }}>✅ <strong>Completed:</strong> 1</p>
              <p style={{ margin: 0 }}>💰 <strong>Total Budget:</strong> $500,000</p>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ margin: '0 0 8px 0' }}>📊 <strong>Progress:</strong> 65%</p>
              <p style={{ margin: '0 0 8px 0' }}>🎯 <strong>Timeline:</strong> On Track</p>
              <p style={{ margin: '0 0 8px 0' }}>💵 <strong>Spending:</strong> 45%</p>
              <p style={{ margin: 0 }}>📅 <strong>Est. Completion:</strong> Jun 30, 2026</p>
            </div>
          </div>
