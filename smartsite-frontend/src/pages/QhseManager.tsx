      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <p style={{
            ...
            You have successfully authenticated. This is the QHSE (Quality, Health, Safety & Environment) Manager dashboard where you can monitor compliance and safety metrics.
          </p>
          <div style={{
            marginTop: '16px',
            padding: '12px 16px',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ margin: '0 0 8px 0' }}>🛡️ <strong>Safety Score:</strong> 98%</p>
              <p style={{ margin: '0 0 8px 0' }}>⚠️ <strong>Incidents:</strong> 0</p>
              <p style={{ margin: '0 0 8px 0' }}>📋 <strong>Audits Completed:</strong> 12</p>
              <p style={{ margin: 0 }}>✅ <strong>Compliance Rate:</strong> 100%</p>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ margin: '0 0 8px 0' }}>📚 <strong>Standards:</strong> ISO 45001, ISO 14001</p>
              <p style={{ margin: '0 0 8px 0' }}>✔️ <strong>Certifications:</strong> 2/2 Valid</p>
              <p style={{ margin: '0 0 8px 0' }}>📝 <strong>Documents:</strong> 45 Updated</p>
              <p style={{ margin: 0 }}>🔄 <strong>Next Audit:</strong> Mar 15, 2026</p>
            </div>
          </div>
