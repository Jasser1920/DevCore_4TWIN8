  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {enabled ? <Check style={{ width: '12px', height: '12px', color: '#148ABB' }} /> : null}
        </div>
      </div>
    </div>
  )
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Customize accessibility features for your own account. These settings stay linked to your user profile.
        </p>
        ...
        <SettingsSection title="Motion & Animation" description="Control animation and motion effects">
          <AccessibilityToggle
            id="reducedMotion"
            label="Reduce Motion"
        ...
        <SettingsSection title="Screen Reader Support" description="Enhance compatibility with screen readers">
          <AccessibilityToggle
        ...
        >
          <Button variant="secondary" onClick={handleResetSettings} ariaLabel="Reset settings to defaults">
            Reset to Defaults
          </Button>
          <Button variant="primary" loading={saveStatus === 'saving'} onClick={handleSaveSettings} ariaLabel="Save accessibility settings">
      ...
      >
        ...
        >
          Your accessibility preferences are automatically saved per user account and restored the next time you log in.
        </p>
      </div>
    </div>
  )
